...
public class TETile {
    ...
    public String description() {
        if (this == Tileset.FLOOR) {
            return "Floor";
        } else if (this == Tileset.WALL) {
            return "Wall";
        } else if (this == Tileset.AVATAR) {
            return "Avatar";
        } else if (this == Tileset.TREASURE) {
            return "Treasure";
        }
        return "Unknown"; // Default description for unknown tiles
    }
